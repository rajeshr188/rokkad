...
- **Plan** - 3 tiers: Starter (₹999), Professional (₹3,999), Enterprise (Custom)
...
Output:
```
✓ Created Starter plan (₹999/month)
✓ Created Professional plan (₹3,999/month)
✓ Created Enterprise plan (Custom pricing)
```
...
<div class="checkout-container">
  ...
  <div class="price-breakdown">
    <div>Base Amount: ₹{{ base_amount }}</div>
    <div>GST ({{ gst_rate }}%): ₹{{ gst_amount }}</div>
...
|------|---------|--------|-------|----------|----------|
| Starter | ₹999 | ₹9,990 | 5 | 500 | Basic |
| Professional | ₹3,999 | ₹39,990 | 50 | 10,000 | Advanced |
...
- Starter: 1,600 users × ₹999 = ₹15.98L/month = ₹1.91Cr/year
- Professional: 400 users × ₹3,999 = ₹15.99L/month = ₹1.92Cr/year
- **Total MRR**: ₹31.97L (~₹2M/month)
- **Annual**: ₹3.83Cr

**Optimistic (35% conversion):**
- Starter: 2,800 users × ₹999 = ₹27.97L/month
- Professional: 700 users × ₹3,999 = ₹27.99L/month
- **Total MRR**: ₹55.96L (~₹3.5M/month)
- **Annual**: ₹6.71Cr
