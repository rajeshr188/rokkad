...
class CustomerTable(tables.Table):
    ...
    # )
    name = tables.Column(verbose_name="Name", attrs={"td": {"style": "width: 20%;"}})
    relatedas = tables.Column(
        verbose_name="R/o", attrs={"td": {"style": "width: 10%;"}}
    )
    relatedto = tables.Column(
        verbose_name="Related To", attrs={"td": {"style": "width: 15%;"}}
    )
    address = tables.Column(
        verbose_name="Address",
        orderable=False,
        empty_values=(),
        attrs={"td": {"style": "width: 25%;"}},
    )
    phonenumber = tables.Column(
        verbose_name="Phone Number",
        orderable=False,
        empty_values=(),
        attrs={"td": {"style": "width: 15%;"}},
    )
    actions = tables.Column(
        orderable=False, empty_values=(), attrs={"td": {"style": "width: 15%;"}}
    )

    def render_name(self, record):
        return format_html(
            """
                <a class="link-info" href="" hx-get="/contact/customer/detail/{}/" 
        ...
        return format_html(
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item link-success" hx-target="#content" hx-get="/girvi/girvi/loan/create/{}"
    ...
    #                 </svg> Customer</a></li>
                    <li><a class="dropdown-item link-danger" hx-delete="/contact/customer/{}/delete/" hx-confirm="Are you sure?" hx-target="closest tr" hx-swap="outerHTML swap:0.5s"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
