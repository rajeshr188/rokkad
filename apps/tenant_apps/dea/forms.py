...
class LoanPaymentCreateForm(forms.Form):
    """Quick form for creating payments from loan detail view."""

    amount = MoneyField(
        label="Payment Amount",
        help_text="Total amount being paid",
    ...
    reference_number = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "placeholder": "Cheque no, transaction ID, bank reference, etc",
            }
        ),
    )
    ...
    is_final = forms.BooleanField(
        label="Final Payment",
        required=False,
        help_text="Check if this payment closes the loan",
        widget=forms.CheckboxInput(
            attrs={
                "class": "form-check-input",
            }
