# Generated by Django 6.0.3 on 2026-09-12 02:03
...
REVERSE = """
DO $$ BEGIN IF EXISTS (SELECT 1 FROM data_portability_childidentity WHERE profile='party-role/1') THEN RAISE EXCEPTION 'Cannot remove role portability with retained identities'; END IF; END $$;
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('data_portability', '0005_childidentity_identifier'),
    ...
    operations = [
        migrations.AddField(
            ...
            name='role',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='exchange_identity', to='party.partyrole'),
        ),
