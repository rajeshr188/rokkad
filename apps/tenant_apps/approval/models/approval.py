...
class ApprovalLine(models.Model):
    ...
    weight = models.DecimalField(
        max_digits=10, decimal_places=3, default=0.0, verbose_name=_("Weight")
    )
    touch = models.DecimalField(
        max_digits=10, decimal_places=3, default=0.0, verbose_name=_("Touch")
    )
