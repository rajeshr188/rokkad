...
### Step 1 — Prepare the visual design externally
...
Typical assets:
- `base_template` — original/front background
- `dup_template` — duplicate/front background
- `terms_template` — original back page
- `form_d3_template` — duplicate back page

---

### Step 2 — Create the template record in Girvi
...
### Step 3 — Choose the correct print mode
...
### Step 5 — Adjust frames carefully
...
### Step 7 — Check the Print Readiness panel
Before promoting a template, review the **Print Readiness** section on the template detail page.

Possible states:
- **Ready** — safe to use
- **Ready with warnings** — works, but some recommended assets/frames are missing
- **Needs attention** — fix the blocking issues before making it default
...
### Step 9 — Set as default only after validation
