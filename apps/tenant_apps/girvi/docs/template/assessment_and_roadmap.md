...
### Phase 1 — Stability and supportability
**Goal:** make the current system safer without changing the core model.

Status: **Largely implemented.**

Actions:
1. Add better exception messages around frame rendering and merge steps. ✅
2. Log the failing `frame_name`, `template_id`, and print mode when a render fails. ✅
3. Add a template readiness check before allowing “Set as Default”. ✅
4. Add a “Test print” action from the template detail screen. ✅
...
### Phase 2 — Governance and authoring workflow
**Goal:** reduce accidental breakage during template editing.

Status: **Partially implemented.**

Actions:
1. Add “Clone Template” action. ✅
2. Add lightweight change history or audit notes. ⏳
3. Separate `draft` vs `active/default` workflow more clearly. ⏳
4. Add stronger warnings when critical files or frames are missing. ✅
...
Actions:
1. Split `build_loan_ticket_pdf()` into smaller helpers/services. ✅
2. Separate frame mapping from render composition. ✅
3. Separate print-option composition from low-level drawing. ✅
4. Push print orchestration consistently through `LoanPrintService`. ✅
...
### Phase 4 — Better preview and extensibility
...
Actions:
1. Add sample-render preview using the real PDF engine. ✅
2. Improve field mapping with a registry/provider approach. ✅
3. Add optional advanced fields without bloating the core UI. ⏳
4. Provide a clearer “supported printable fields” reference in docs/UI. ⏳
...
### Short-term roadmap (recommended next 2–4 PRs)
...
- make “clone then edit” the safest recommended path
...
### PR-1 — Print readiness and diagnostics
...
### PR-2 — Clone template and safe edit workflow
...
**Tasks**
- [x] Add “Clone Template” action on template detail/list views.
...
### PR-3 — Service-layer consolidation and renderer modularization
...
### PR-4 — Preview fidelity and test-print workflow
...
**Tasks**
- [x] Add a “Test Print” action from template detail.
...
### PR-5 — Optional extensibility improvements
