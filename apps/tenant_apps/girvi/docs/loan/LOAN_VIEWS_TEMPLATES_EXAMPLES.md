        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    ...
                    <h2>₹{{ summary.total_due|floatformat:0 }}</h2>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    ...
                    <h2>₹{{ summary.total_value|floatformat:0 }}</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr class="{% if loan.is_overdue %}table-danger{% else %}table-success{% endif %}">
                        ...
                        <td>
                            ...
                            <br>
                            <small class="text-muted">₹{{ loan.gold_loanamount|floatformat:0 }}</small>
                        </td>
                        <td>
                            {{ loan.silver_weight|floatformat:2 }}g
                            <br>
                            <small class="text-muted">₹{{ loan.silver_loanamount|floatformat:0 }}</small>
                        </td>
                        <td>₹{{ loan.loan_amount|floatformat:0 }}</td>
                        <td>₹{{ loan.total_interest|floatformat:0 }}</td>
                        <td>
                            ₹{{ loan.total_due|floatformat:0 }}
                            <br>
                            <small class="text-muted">
                                {% if loan.is_overdue %}
                                    Short: ₹{{ loan.total_due|add:loan.total_current_value|floatformat:0 }}
                                {% endif %}
                            </small>
                        </td>
        ...
        <div class="col-lg-3 mb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3>₹<span class="currency">{{ overall.total_due|floatformat:0 }}</span></h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 mb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3>₹<span class="currency">{{ overall.total_value|floatformat:0 }}</span></h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 mb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3>₹<span class="currency">{{ overall.total_due|add:overall.total_value|floatformat:0 }}</span></h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <h4>₹{{ non_performing.total_due|floatformat:0 }}</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <h6 class="text-muted">Collateral Value</h6>
                            <h4>₹{{ non_performing.total_collateral_value|floatformat:0 }}</h4>
                        </div>
                        <div class="col-sm-6">
                            <h6 class="text-muted">Shortfall</h6>
                            <h4 class="text-danger">
                                ₹{{ non_performing.total_due|add:non_performing.total_collateral_value|floatformat:0 }}
                            </h4>
                        </div>
                    </div>
                    ...
                    <table class="table table-sm">
                        ...
                        <tr>
                            ...
                            <td>₹{{ data.value|floatformat:0 }}</td>
                        </tr>
                        {% endfor %}
                    </table>
            ...
            <div class="card border-warning">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <h6 class="text-muted">Total Due</h6>
                            <h4>₹{{ long_dead.total_due|floatformat:0 }}</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <h6 class="text-muted">Collateral Value</h6>
                            <h4>₹{{ long_dead.total_collateral_value|floatformat:0 }}</h4>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <h4>
                                {% if long_dead.total_due > long_dead.total_collateral_value %}
                                    <span class="text-danger">
                                        -₹{{ long_dead.total_due|add:long_dead.total_collateral_value|floatformat:0 }}
                                    </span>
                                {% else %}
                                    <span class="text-success">
                                        +₹{{ long_dead.total_collateral_value|add:long_dead.total_due|floatformat:0 }}
                                    </span>
                                {% endif %}
                            </h4>
                        </div>
