...
✅ **Globally Unique** - No ambiguity, "A00123" is unique across all loans  
✅ **Simple Model** - One FK (series), no complex constraints  
✅ **Natural Sorting** - Alphabetical sorting works perfectly  
✅ **Clear Communication** - "Loan A00123" is unambiguous  
✅ **Audit-Friendly** - Every reference is unique
...
|--------|--------------|------------------|
| **loan_id Type** | Integer | **String (formatted)** ✅ |
| **Series** | Optional | **Required** ✅ |
| **License FK** | Direct | **Via series** ✅ |
| **reference_id** | Separate field | **Not needed** ✅ |
| **Uniqueness** | Per-series/license | **Global** ✅ |
| **Constraints** | Complex UniqueConstraint | **Simple unique=True** ✅ |
| **Sorting** | Needs context | **Natural alphabetical** ✅ |
| **Display** | Needs formatting | **Already formatted** ✅ |

## Best Practices

1. ✅ **Always provide series** when creating loans
2. ✅ **Let save() auto-generate** loan_id (don't manually set unless importing)
3. ✅ **Use PROTECT on_delete** for series FK (prevent accidental deletion)
4. ✅ **Create default series** for new users who don't need multiple books
5. ✅ **Use loan.loan_id directly** in UI (no formatting needed)
...
```python
# Before:
loan = GivenLoan(customer=customer)  # ❌ No series
...
loan = GivenLoan(series=series, customer=customer)
# loan.loan_id = "A00123"  # ❌ Don't do this
loan.save()  # ✅ Auto-generates unique ID
```
