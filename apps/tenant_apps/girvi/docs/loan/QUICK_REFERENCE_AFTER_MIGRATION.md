...
```python
# ❌ Wrong - old Loan model field
loan.customer

# ✅ Correct - new model uses specific field names
...
```python
# ❌ Wrong - assuming combined queryset
Loan.objects.filter(loan_type='Given')

# ✅ Correct - use specific model
...
- **Feb 24, 2026**: ✅ Complete (you are here)
