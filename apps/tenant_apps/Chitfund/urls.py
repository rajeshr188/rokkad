...
urlpatterns = (
    ...
    path(
        "contact/detail/<slug:slug>/",
        views.ContactDetailView.as_view(),
        name="contact_detail",
    ),
    path(
        "contact/update/<slug:slug>/",
...
urlpatterns += (
    ...
    path(
        "chit/detail/<slug:slug>/", views.ChitDetailView.as_view(), name="chit_detail"
    ),
    path(
        "chit/update/<slug:slug>/", views.ChitUpdateView.as_view(), name="chit_update"
    ),
)
...
urlpatterns += (
    ...
    path(
        "collection/create/<int:pk>/",
        views.CollectionCreateView.as_view(),
        name="collection_create",
    ),
    path(
        "collection/detail/<slug:slug>/",
        views.CollectionDetailView.as_view(),
        name="collection_detail",
    ),
    path(
        "collection/update/<slug:slug>/",
...
urlpatterns += (
    ...
    path(
        "allotment/create/<int:pk>/",
        views.AllotmentCreateView.as_view(),
        name="allotment_create",
    ),
    path(
        "allotment/detail/<slug:slug>/",
        views.AllotmentDetailView.as_view(),
        name="allotment_detail",
    ),
    path(
        "allotment/update/<slug:slug>/",
        views.AllotmentUpdateView.as_view(),
        name="allotment_update",
    ),
)
