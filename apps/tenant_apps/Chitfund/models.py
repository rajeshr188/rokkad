...
class Chit(models.Model):
    ...
    owner = models.OneToOneField(
        "Contact", on_delete=models.CASCADE, related_name="owner"
    )
    members = models.ManyToManyField("Contact", related_name="members")
...
class Allotment(models.Model):
    ...
    # Relationship Fields
    chit = models.ForeignKey("Chit", on_delete=models.CASCADE)
    to_member = models.ForeignKey("Contact", on_delete=models.CASCADE)
