...
class Payment(models.Model):
    ...
    invoices = models.ManyToManyField("purchase.Purchase", through="PaymentAllocation")
    ...
    def allocate(self):
        ...
        unpaid_invoices = (
            Purchase.with_outstanding_balance().filter(filter_q).order_by("created")
        )
...
class PaymentAllocation(models.Model):
    ...
    invoice = models.ForeignKey("purchase.Purchase", on_delete=models.CASCADE)
