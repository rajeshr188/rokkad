...
# Migration Guide: Old Loan Model â†’ GivenLoan/TakenLoan

## âœ… MIGRATION COMPLETE (as of Feb 24, 2026)
...
- Line 104, 121: Change `Loan.objects` â†’ `GivenLoan.objects` or route context
...
- Line 359: `Loan.objects.create()` â†’ `TakenLoan.objects.create()`
