...
- `loan.loan_date`
- the loanâ€™s monthly/base interest amount (`get_interest_amount`)
...
- As-of date: `2026-02-14` â†’ **0 months accrued**
- As-of date: `2026-02-15` â†’ **1 month accrued**
- As-of date: `2026-03-15` â†’ **2 months accrued**
...
- `EOM` â†’ run on the last day of the month
- `BOM` â†’ run on the first day of the month
...
- `apps/orgs/views.py` â†’ `CompanyPreferenceBuilder`
...
The packageâ€™s own default URLs are also currently mounted at:
- `/dynamic_preferences/`
...
The runtime helper:
- `apps/orgs/preferences.py` â†’ `CompanyPreferences`
