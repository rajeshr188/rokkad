...
I'll turn the lifecycle proposal into an implementation-ready state-transition matrix with guards and reversibility rules.## GivenLoan lifecycle â€” implementation-ready state-transition matrix
...
> â€œcloseâ€ = create release doc + deliver items from custody
...
# 6) Guard conditions â€” implementation checklist
...
This is the most direct â€œready for implementationâ€ form.
