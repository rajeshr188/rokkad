...
### 1. **Threshold Configuration**
   ...
   - **Loan Amount Threshold**: Maximum total amount of active loans allowed (in â‚¹)
...
â”œâ”€â”€ Loan Count Threshold: e.g., 100
â”œâ”€â”€ Loan Amount Threshold: e.g., 5000000 (â‚¹5 million)
â”œâ”€â”€ Deactivation Rule: LOANS_ONLY / RELEASES_ONLY / BOTH
â””â”€â”€ (Automated fields shown below)
    â”œâ”€â”€ Deactivated for Loans
    â”œâ”€â”€ Deactivated for Releases
    â”œâ”€â”€ Deactivation Date
    â””â”€â”€ Threshold Exceeded Reason
```
...
**Scenario**: Silver loan series with max â‚¹10 million exposure
...
**Behavior**:
- When total active loan amount reaches â‚¹10 million:
...
- âœ“ Active - Series is fully operational
- âš ï¸ Threshold exceeded - At least one threshold breached
- ðŸ”’ Loans disabled - Cannot create new loans
- ðŸ”’ Releases disabled - Cannot create new releases
- ðŸ”’ Locked (loans & releases) - Completely deactivated
