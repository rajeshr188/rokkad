...
loan_amount_threshold             # Max loan amount allowed (â‚¹)
...
series.loan_amount_threshold = 5000000  # Max â‚¹5 million
...
# â†’ deactivated_for_loans = True
# â†’ Disappears from loan form
# â†’ Error if trying to create another loan programmatically
```

### Scenario 2: Amount Control
```python
series.loan_amount_threshold = Decimal("10000000")  # â‚¹10M
series.deactivation_rule = "BOTH"  # Lock both operations

# At â‚¹10M exposure:
# â†’ deactivated_for_loans = True
# â†’ deactivated_for_releases = True
# â†’ Neither form shows this series
```
...
# â†’ Only deactivated_for_releases = True
# â†’ Can still create new loans
# â†’ Cannot release existing loans
```
