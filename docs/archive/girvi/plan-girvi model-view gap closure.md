...
- [x] Update 6 tab view functions in `loan.py` (lines 590â€“680) to use `"loan_detail_1.html#<name>"` fragment path
...
- [x] `loan_table_partial` view â†’ `render(request, "girvi/loan/loan_list.html#loan-table", context)`
...
- [x] Inline `storagebox_list_partial.html` â†’ `storagebox_list.html#storagebox-list`; delete standalone
