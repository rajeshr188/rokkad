...
> Historical snapshot from docs/plans/active.md before the 2026-09-09 documentation cleanup.
...
Current delivery: [incremental project hardening](../../../../plans/project-hardening.md), following
the approved architecture review. Foundation, operator commands and billing
implementation are complete locally. Razorpay setup/provider testing is shelved
as [FW-002](../../../../plans/future-work.md#fw-002-razorpay-setup-and-provider-test-mode-acceptance)
at the owner's request; it remains required before real paid onboarding.
Next: R08 current documentation/dependency-policy cleanup, followed by R09/R10
onboarding and obsolete settings/guardrails. License scoping remains shelved.
...
[FW-001](../../../../plans/future-work.md#fw-001-optional-owner-configurable-license-scope); it is not
automatically the next implementation task. It requires a fresh review and explicit
owner approval. Use [Future work](../../../../plans/future-work.md) for newly shelved ideas.

Follow the [incremental delivery register](../../../../plans/saas-access-media-and-onboarding.md).
...
1. Action/service fixes and AP-06 local stored grants are implemented, including
   ...
   [role delivery record](../../../../plans/workspace-role-migration.md). Keep future role presets separate.
...
- [Phase 9 execution plan](../../../../plans/control-plane-phase9-app-conformance.md)
...
- [Phase 8 execution plan](../../../../plans/control-plane-phase8-contract-tests.md)
- [Accepted contracts](../../../../architecture/control-plane-contracts.md)
...
- [Phased removal plan](../../../../plans/django-tenants-removal.md)
...
- [Phased execution plan](../../../../plans/contact-girvi-legacy-notify-retirement.md)
...
- [Archived full spec](../../../girvi/GIRVI_EVENT_DRIVEN_DEA_POSTING_SPEC.md)
...
- [Party rollout plan](../../../../plans/party-rollout.md)
...
- [Girvi release and accrual hardening plan](../../../../plans/girvi-release-accrual-hardening.md)
...
- [Centralized preferences architecture plan](../../../../plans/centralized-preferences-architecture-plan.md)
