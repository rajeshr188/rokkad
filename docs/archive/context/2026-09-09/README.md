...
> Historical snapshot from docs/README.md before the 2026-09-09 documentation cleanup.
...
This folder is the living documentation system. Historical notes, audits, and superseded plans are preserved under [archive](../..).

- [Subscription checkout and recovery limits](../../../flows/subscription-checkout.md)
...
- [2026-09-09 project review: SaaS gaps, structure and legacy cleanup](../../../architecture/2026-09-09-project-review.md)
...
- [Containers, CI and runtime startup gates](../../../implementation/container-and-ci.md)
- [Workspace-aware Loans operator commands](../../../implementation/loans-operator-commands.md)
