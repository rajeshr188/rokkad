...
â”‚                        ROLE HIERARCHY                       â”‚
â”‚                                                             â”‚
â”‚     Owner (71 perms)          - Full control                â”‚
â”‚       â†“                                                     â”‚
â”‚     Admin (55 perms)          - Operations manager          â”‚
â”‚       â†“                                                     â”‚
â”‚     Member (35 perms)         - Standard user               â”‚
â”‚       â†“                                                     â”‚
â”‚     Viewer (16 perms)         - Read-only access            â”‚
â”‚                                                             â”‚
...
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `workspace_view` | Can view workspace | âœ… | âœ… | âœ… | âœ… | View workspace details and settings |
| `workspace_list` | Can list workspaces | âœ… | âœ… | âœ… | âœ… | View list of accessible workspaces |
| `workspace_edit` | Can edit workspace | âœ… | âœ… | âŒ | âŒ | Edit workspace settings |
| `workspace_settings` | Can manage settings | âœ… | âœ… | âŒ | âŒ | Manage advanced workspace settings |
| `workspace_delete` | Can delete workspace | âœ…ðŸ”’ | âŒ | âŒ | âŒ | Permanently delete workspace |
| `workspace_archive` | Can archive workspace | âœ…ðŸ”’ | âŒ | âŒ | âŒ | Soft delete/archive workspace |
| `workspace_transfer` | Can transfer ownership | âœ…ðŸ”’ | âŒ | âŒ | âŒ | Transfer ownership to another user |
...
| Permission Codename | Name | Owner | Admin | Member | Viewer | Description |
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `team_view` | Can view team | âœ… | âœ… | âœ… | âœ… | View team members and roles |
| `team_list` | Can list members | âœ… | âœ… | âœ… | âœ… | View full team member list |
| `team_invite` | Can invite members | âœ… | âœ… | âŒ | âŒ | Send invitations to new members |
| `team_invite_admin` | Can invite admins | âœ…ðŸ”’ | âŒ | âŒ | âŒ | Send invitations with admin role |
| `team_edit` | Can edit member | âœ… | âœ… | âŒ | âŒ | Edit team member details |
| `team_remove` | Can remove members | âœ… | âœ… | âŒ | âŒ | Remove members from workspace |
| `team_change_role` | Can change roles | âœ… | âœ… | âŒ | âŒ | Change team member roles |
| `team_view_activity` | Can view activity | âœ… | âŒ | âŒ | âŒ | View member activity logs |
...
| Permission Codename | Name | Owner | Admin | Member | Viewer | Description |
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `data_view` | Can view data | âœ… | âœ… | âœ… | âœ… | View all data in workspace |
| `data_view_own` | Can view own data | âœ… | âœ… | âœ… | âœ… | View only own created data |
| `data_create` | Can create data | âœ… | âœ… | âœ… | âŒ | Create new data entries |
| `data_edit` | Can edit data | âœ… | âœ… | âœ… | âŒ | Edit any data entry |
| `data_edit_own` | Can edit own data | âœ… | âœ… | âœ… | âŒ | Edit only own data |
| `data_delete` | Can delete data | âœ… | âœ… | âŒ | âŒ | Delete any data entry |
| `data_delete_own` | Can delete own data | âœ… | âœ… | âœ… | âŒ | Delete only own data |
| `data_export` | Can export data | âœ… | âœ… | âŒ | âŒ | Export data to CSV/Excel/PDF |
| `data_export_bulk` | Can bulk export | âœ… | âœ… | âŒ | âŒ | Export large datasets |
| `data_import` | Can import data | âœ… | âœ… | âŒ | âŒ | Import data from files |
...
| Permission Codename | Name | Owner | Admin | Member | Viewer | Description |
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `billing_view` | Can view billing | âœ… | âœ… | âŒ | âŒ | View billing info and invoices |
| `billing_history` | Can view history | âœ… | âœ… | âŒ | âŒ | View payment history |
| `billing_edit` | Can edit billing | âœ…ðŸ”’ | âŒ | âŒ | âŒ | Update payment methods |
| `billing_manage` | Can manage subscription | âœ…ðŸ”’ | âŒ | âŒ | âŒ | Change subscription plans |
| `billing_cancel` | Can cancel subscription | âœ…ðŸ”’ | âŒ | âŒ | âŒ | Cancel workspace subscription |
...
| Permission Codename | Name | Owner | Admin | Member | Viewer | Description |
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `report_view` | Can view reports | âœ… | âœ… | âœ… | âœ… | View all reports |
| `report_view_basic` | Can view basic reports | âœ… | âœ… | âœ… | âœ… | View basic reports only |
| `report_create` | Can create reports | âœ… | âœ… | âŒ | âŒ | Create custom reports |
| `report_export` | Can export reports | âœ… | âœ… | âœ… | âŒ | Export reports to files |
| `report_schedule` | Can schedule reports | âœ… | âœ… | âŒ | âŒ | Schedule automated reports |
...
| Permission Codename | Name | Owner | Admin | Member | Viewer | Description |
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `girvi_loan_view` | Can view loans | âœ… | âœ… | âœ… | âœ… | View loan details |
| `girvi_loan_create` | Can create loans | âœ… | âœ… | âœ… | âŒ | Create new loan entries |
| `girvi_loan_edit` | Can edit loans | âœ… | âœ… | âœ… | âŒ | Edit loan details |
| `girvi_loan_delete` | Can delete loans | âœ… | âœ… | âŒ | âŒ | Delete loan entries |
| `girvi_loan_approve` | Can approve loans | âœ… | âœ… | âŒ | âŒ | Approve loan applications |
| `girvi_loan_release` | Can release loans | âœ… | âœ… | âŒ | âŒ | Release completed loans |
| `girvi_loan_payment` | Can record payments | âœ… | âœ… | âœ… | âŒ | Record loan payments |
| `girvi_loan_bulk` | Can bulk operations | âœ… | âœ… | âŒ | âŒ | Bulk loan operations |
| `girvi_report_view` | Can view reports | âœ… | âœ… | âœ… | âœ… | View loan reports |
...
| Permission Codename | Name | Owner | Admin | Member | Viewer | Description |
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `dea_entry_view` | Can view entries | âœ… | âœ… | âœ… | âœ… | View accounting entries |
| `dea_entry_create` | Can create entries | âœ… | âœ… | âœ… | âŒ | Create journal entries |
| `dea_entry_edit` | Can edit entries | âœ… | âœ… | âœ… | âŒ | Edit accounting entries |
| `dea_entry_delete` | Can delete entries | âœ… | âœ… | âŒ | âŒ | Delete accounting entries |
| `dea_reconciliation` | Can reconcile | âœ… | âœ… | âŒ | âŒ | Reconcile accounts |
| `dea_close_period` | Can close periods | âœ… | âœ… | âŒ | âŒ | Close accounting periods |
| `dea_report_view` | Can view reports | âœ… | âœ… | âŒ | âœ… | View financial reports |
| `dea_report_export` | Can export reports | âœ… | âœ… | âŒ | âŒ | Export financial reports |
...
| Permission Codename | Name | Owner | Admin | Member | Viewer | Description |
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `sales_invoice_view` | Can view invoices | âœ… | âœ… | âœ… | âœ… | View sales invoices |
| `sales_invoice_create` | Can create invoices | âœ… | âœ… | âœ… | âŒ | Create sales invoices |
| `sales_invoice_edit` | Can edit invoices | âœ… | âœ… | âœ… | âŒ | Edit sales invoices |
| `sales_invoice_delete` | Can delete invoices | âœ… | âœ… | âŒ | âŒ | Delete sales invoices |
| `sales_payment_record` | Can record payments | âœ… | âœ… | âœ… | âŒ | Record sales payments |
| `sales_discount_apply` | Can apply discounts | âœ… | âœ… | âŒ | âŒ | Apply discounts to invoices |
| `sales_report_view` | Can view reports | âœ… | âœ… | âŒ | âŒ | View sales analytics |
...
| Permission Codename | Name | Owner | Admin | Member | Viewer | Description |
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `purchase_order_view` | Can view orders | âœ… | âœ… | âœ… | âœ… | View purchase orders |
| `purchase_order_create` | Can create orders | âœ… | âœ… | âœ… | âŒ | Create purchase orders |
| `purchase_order_edit` | Can edit orders | âœ… | âœ… | âŒ | âŒ | Edit purchase orders |
| `purchase_order_delete` | Can delete orders | âœ… | âœ… | âŒ | âŒ | Delete purchase orders |
| `purchase_order_approve` | Can approve orders | âœ… | âœ… | âŒ | âŒ | Approve purchase orders |
| `purchase_report_view` | Can view reports | âœ… | âœ… | âŒ | âŒ | View purchase analytics |
...
| Permission Codename | Name | Owner | Admin | Member | Viewer | Description |
|---------------------|------|:-----:|:-----:|:------:|:------:|-------------|
| `contact_view` | Can view contacts | âœ… | âœ… | âœ… | âœ… | View contact details |
| `contact_create` | Can create contacts | âœ… | âœ… | âœ… | âŒ | Create new contacts |
| `contact_edit` | Can edit contacts | âœ… | âœ… | âœ… | âŒ | Edit contact details |
| `contact_delete` | Can delete contacts | âœ… | âœ… | âŒ | âŒ | Delete contacts |
| `contact_import` | Can import contacts | âœ… | âœ… | âŒ | âŒ | Import from CSV/Excel |
| `contact_export` | Can export contacts | âœ… | âœ… | âŒ | âŒ | Export to CSV/Excel |
...
1. âœ… **Install django-guardian:** `pip install django-guardian`
2. âœ… **Run setup command:** `python manage.py setup_permissions`
3. âœ… **Verify roles created:** Check admin panel
4. âœ… **Update views:** Add permission decorators
5. âœ… **Update templates:** Add permission checks
6. âœ… **Test thoroughly:** Run permission test suite
