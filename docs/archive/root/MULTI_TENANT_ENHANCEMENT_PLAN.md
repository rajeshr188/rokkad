...
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ workspace_view  â”‚   âœ“    â”‚   âœ“   â”‚   âœ“    â”‚
â”‚ workspace_edit  â”‚   âœ“    â”‚   âœ“   â”‚        â”‚
â”‚ workspace_del   â”‚   âœ“    â”‚       â”‚        â”‚
â”‚ team_view       â”‚   âœ“    â”‚   âœ“   â”‚   âœ“    â”‚
â”‚ team_invite     â”‚   âœ“    â”‚   âœ“   â”‚        â”‚
â”‚ team_remove     â”‚   âœ“    â”‚       â”‚        â”‚
â”‚ billing_view    â”‚   âœ“    â”‚   âœ“   â”‚        â”‚
â”‚ billing_edit    â”‚   âœ“    â”‚       â”‚        â”‚
â”‚ data_view       â”‚   âœ“    â”‚   âœ“   â”‚   âœ“    â”‚
â”‚ data_edit       â”‚   âœ“    â”‚   âœ“   â”‚   âœ“    â”‚
â”‚ data_export     â”‚   âœ“    â”‚   âœ“   â”‚        â”‚
...
def feature_required(feature_name):
    ...
    Examples:
    - 'advanced_reporting' â†’ Pro/Enterprise plans only
    - 'api_access' â†’ Premium plans only
    - 'multi_warehouse' â†’ Enterprise only
    - 'team_management' â†’ All paid plans
    """
...
def permission_required(required_permission):
    ...
    - workspace_view    â†’ Owner, Admin, Member
    - workspace_edit    â†’ Owner, Admin
    - workspace_delete  â†’ Owner only
    - team_invite       â†’ Owner, Admin
    - team_remove       â†’ Owner only
    - billing_view      â†’ Owner, Admin
    - billing_edit      â†’ Owner only
    - data_export       â†’ Owner, Admin
    """
    PERMISSION_ROLES = {
...
Unauthenticated User
        â†“
[Home Page] â†’ [Sign In / Sign Up]
        â†“
[Dashboard] â† PROBLEM: No clear next step, multiple paths
    â”œâ†’ Create Company (unclear if needed)
    â”œâ†’ View Existing Companies (may not have any)
    â”œâ†’ Manage Subscriptions (not prominent)
    â”œâ†’ View Invitations (if any)
    â””â†’ Select Workspace (required but UI unclear)
        â†“
...
```
â”Œâ”€ Dashboard (Home) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚                                         â”‚
â”‚ Welcome back, [User Name]!             â”‚
â”‚                                         â”‚
â”‚ â”Œâ”€ Your Workspaces â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”  â”‚
â”‚ â”‚ [Company 1] - Last accessed 2h agoâ”‚  â”‚
â”‚ â”‚ [Company 2] - Last accessed 5d agoâ”‚  â”‚
â”‚ â”‚ [+] Create New Workspace          â”‚  â”‚
â”‚ â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜  â”‚
â”‚                                         â”‚
â”‚ â”Œâ”€ Invitations (if any) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”  â”‚
â”‚ â”‚ [Invite from Company] - Expires.. â”‚  â”‚
â”‚ â”‚ [Accept] [Decline]               â”‚  â”‚
â”‚ â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜  â”‚
â”‚                                         â”‚
â”‚ â”Œâ”€ Account Actions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”  â”‚
â”‚ â”‚ [Profile Settings] [Subscription]  â”‚  â”‚
â”‚ â”‚ [Billing History]  [Support]       â”‚  â”‚
â”‚ â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜  â”‚
â”‚                                         â”‚
...
# user.company.com/workspace/ â†’ Auto-load that workspace

# OPTION 2: Workspace Selector
# app.com/select-workspace/ â†’ List user's workspaces
# OR app.com/workspace/[id]/enter/ â†’ Enter specific workspace
...
<div class="workspace-switcher">
    <span>ðŸ“¦ Current Workspace: {{ request.tenant.name }}</span>
...
<div class="team-member">
    ...
    <div class="member-actions">
        {% if 'team_edit' in user_permissions %}
            <a href="..." class="icon-btn" title="Edit">âœï¸</a>
            <a href="..." class="icon-btn" title="Remove">ðŸ—‘ï¸</a>
        {% endif %}
    </div>
</div>
```
...
<div class="help-banner">
    ...
    <button class="close-help" aria-label="Close">Ã—</button>
</div>
```
...
This plan resolves:
- âŒ No row-level permission system â†’ âœ… Django-guardian + custom permissions
- âŒ Unclear authorization â†’ âœ… Explicit permission decorators and context processors
- âŒ Poor onboarding â†’ âœ… Guided wizard and in-app tours
- âŒ Dual templates â†’ âœ… Unified base + conditional components
- âŒ Hidden features â†’ âœ… Progressive disclosure + feature gating
- âŒ No audit trail â†’ âœ… Comprehensive AuditLog model
- âŒ Subscription enforcement â†’ âœ… Middleware-level validation
