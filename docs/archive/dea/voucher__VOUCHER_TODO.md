...
# 3. Create mapping: type â†’ GL account mapping rules
```
...
|------|----------|--------|--------|
| Line Item CRUD | HIGH | 2-3h | â³ TODO |
| JE Creation Logic | HIGH | 1-2h | â³ TODO |
| Include Templates | HIGH | 30m | â³ TODO |
| Integration Tests | MEDIUM | 4-6h | â³ TODO |
| Signal Handlers | MEDIUM | 2-3h | â³ TODO |
| Auto-Numbering | MEDIUM | 1h | â³ TODO |
| Permissions | MEDIUM | 1-2h | â³ TODO |
| Integration with Docs | HIGH | 2-3h | â³ TODO |
| Reporting | LOW | 3-4h | â³ OPTIONAL |
| Approval Workflow | OPTIONAL | 2-3h | â³ OPTIONAL |
| Type Configuration | MEDIUM | 1-2h | â³ TODO |
