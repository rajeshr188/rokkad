...
|---------|-----------|-----------------|----------------|
| **Monthly Price** | â‚¹999 | â‚¹3,999 | Custom |
| **Yearly Price** | â‚¹9,990 | â‚¹39,990 | Custom |
...
| **Advanced Reports** | âŒ | âœ… | âœ… |
| **Multi-Warehouse** | âŒ | âœ… | âœ… |
| **Approvals Workflow** | âŒ | âœ… | âœ… |
| **API Access** | âŒ | âŒ | âœ… |
| **Custom Fields** | âŒ | âœ… | âœ… |
...
```
Starter Tier:
- Monthly: â‚¹999 Ã— 8,000 customers = â‚¹79,92,000/month
- Annual recurring: â‚¹9,990 Ã— 2,000 customers = â‚¹1,99,80,000/year

Professional Tier:
- Monthly: â‚¹3,999 Ã— 1,500 customers = â‚¹59,98,500/month
- Annual recurring: â‚¹39,990 Ã— 500 customers = â‚¹1,99,95,000/year

Enterprise Tier:
- Custom pricing: â‚¹500 Ã— 100 customers (avg) = â‚¹50,000/month avg
```

### 2. **Add-On Charges**
- **Extra Users**: â‚¹99/user/month (for overflow beyond plan limit)
- **Advanced Integrations**: â‚¹2,000-5,000/month
- **Dedicated Support**: â‚¹5,000-10,000/month
- **Custom Development**: â‚¹50,000+ (one-time)

### 3. **Transaction-Based Revenue (Optional)**
For companies preferring usage-based pricing:
- Per Invoice: â‚¹2-5
- Per Transaction: â‚¹0.50-1
- Per SKU managed: â‚¹0.10-0.50
...
- âœ… Credit/Debit Cards (all major banks)
- âœ… Net Banking (ICICI, HDFC, SBI, Axis, etc.)
- âœ… UPI (Google Pay, PhonePe, etc.)
- âœ… Digital Wallets (Paytm, etc.)
- âœ… Recurring Payments (E-Mandate for auto-renewal)
...
- âœ… Database models created (Plan, Subscription, Invoice, Payment)
- âœ… Razorpay service integration
- â¬œ Payment checkout page
- â¬œ Invoice generation and email delivery
- â¬œ Invoice download (PDF) feature
- â¬œ Trial period management

### Phase 2: Operations (Month 3-4)
- â¬œ Billing dashboard (view invoices, usage, renewal date)
- â¬œ Plan upgrade/downgrade flow
- â¬œ Auto-renewal and dunning management
- â¬œ Feature access control based on plan tier
- â¬œ Usage metrics tracking

### Phase 3: Scale (Month 5-6)
- â¬œ Annual billing option
- â¬œ Coupon/discount codes
- â¬œ Referral program (e.g., 20% commission per referral)
- â¬œ White-label pricing for resellers
- â¬œ Custom pricing overrides for enterprise deals

### Phase 4: Growth (Month 7+)
- â¬œ Analytics dashboard (MRR, ARR, churn rate)
- â¬œ Automated dunning and retry logic
- â¬œ API rate limiting based on tier
- â¬œ Multi-currency support
- â¬œ Marketplace for add-ons
...
Churn Rate = (Cancelled customers / Total customers) Ã— 100
CAC (Customer Acquisition Cost) = Marketing spend / New customers
LTV (Lifetime Value) = (ARPU Ã— Gross margin) / Monthly churn rate
```
...
1. **Email Campaign** (Day 14)
   ...
   - Limited-time discount (â‚¹500 off first month)
...
- **CAC**: â‚¹5,000-15,000 per customer
- **LTV**: â‚¹3,00,000-10,00,000+
