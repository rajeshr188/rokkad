...
| Routing, dashboard and module organization | R07/R11/R12 | R07 and R11 complete locally; R12 started: product-catalog, economic and license/series setup extracted; remaining module families pending |
...
4. R11 visibility, batching and [query measurements](../implementation/dashboard-reliability.md) complete.
   ...
   product-catalog, economic and license/series setup are extracted after checkpoint c9e27f9;
   document print-profile setup is next.
