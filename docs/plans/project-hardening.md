...
| Routing, dashboard and module organization | R07/R11/R12 | R07 and R11 complete locally; Loans views portion of R12 complete; orgs workspace/role settings extracted; team/invitations extracted; lifecycle/navigation next; broader model/form/renewal review separate |
...
4. R11 visibility, batching and [query measurements](../implementation/dashboard-reliability.md) complete.
   ...
   invitations are also extracted; lifecycle/navigation are next; see the [orgs module map](../implementation/orgs-view-organization.md).
