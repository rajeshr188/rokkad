...
| Routing, dashboard and module organization | R07/R11/R12 | R07 and R11 complete locally; R12 module organization remains |
...
4. R11 visibility, batching and [query measurements](../implementation/dashboard-reliability.md) complete.
   ...
   starting with the five product-catalog setup views after the reviewed checkpoint.
